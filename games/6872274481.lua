...
run(function()
	...
	vape.Components.HotbarList = function(optionsettings, children, api)
		...
		textbuttonicon.Image = getcustomasset('noboline/assets/new/add.png')
			...
			local mounted = bedwars.Roact.mount(create('BillboardGui', {
				...
				create('Frame', {
					...
					create('ImageLabel', {
						...
						BackgroundTransparency = 1,
						Image = getcustomasset('noboline/assets/new/blur.png'),
...
run(function()
	...
	KillEffect = vape.Categories.World:CreateModule({
		Name = 'Kill Effect',
		Function = function(callback)
			if callback then
...
run(function()
	...
	WinEffect = vape.Categories.World:CreateModule({
		Name = 'WinEffect',
		Function = function(callback)
			if callback then
